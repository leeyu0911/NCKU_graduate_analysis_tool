...
def deal_data(start_year, end_year, degree, advisor_name, q):
    system_ID = []
    paper = []
    url = 'http://etds.lib.ncku.edu.tw/etdservice/searching?start=1&end=300&amount=300&degree=' + degree + \
          '&language=all&&dfile=all&a_year_end=' + str(end_year) + \
          '&a_year_start=' + str(start_year) + \
          '&query_field1=advisor&query_word1=' + advisor_name
    ...
    q.put([paper, exam_method, recommend_method, other_method, year_data, advisor_name])
